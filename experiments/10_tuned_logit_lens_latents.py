...
results = run_inference_with_tuned_logit_lens(
    model=model,
    tokenizer=tokenizer,
    prompt=PROMPT,
    num_latent_iterations=NUM_LATENT_ITERATIONS,
    top_k=TOP_K_TOKENS,
    translators_path="/home/chriskino/codi/tuned_lens/custom_codi_GSM8K/default_codi_6_GSM8K_odd.pt"
)
# %%
...
if fig is not None:
    ...
    output_path = os.path.join(results_dir, "logit_lens_latents_10_odd.png")
